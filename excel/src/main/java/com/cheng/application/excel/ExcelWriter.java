package com.cheng.application.excel;

import com.cheng.application.basic.Predef;
import com.cheng.application.datatimes.TimeToolkit;
        ...
        for (int i = 0; i < datasize; i++) {
            ...
            while (it.hasNext()) {
                ...
                if (stringStringMap != null) {
                    String translatervalue = stringStringMap.get(Predef.toStr(entry.getValue()));
